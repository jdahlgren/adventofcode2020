...
internal class Day9Test {
    ...
    fun part2Example() {
        val input = listOf(35, 20, 15, 25, 47, 40, 62, 55, 65, 95, 102, 117, 150, 182, 127, 219, 299, 277, 309, 576)
        val day9 = Day9(input)
        val invalidNumber = day9.findEncryptionWeakness(5)
        assertEquals(62, invalidNumber)
    }
    ...
    fun part2() {
        val input = readFileToLongList("day9").map { it.toInt() }
        val day9 = Day9(input)
        val invalidNumber = day9.findEncryptionWeakness(25)
        assertEquals(8249240, invalidNumber)
    }
}